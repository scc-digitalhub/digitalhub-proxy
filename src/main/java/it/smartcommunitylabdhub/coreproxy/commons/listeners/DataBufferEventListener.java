...
@Component
@Slf4j
public class DataBufferEventListener implements InitializingBean {
    ...
    @Autowired
    public DataBufferEventListener(@Value("${mapper.module}") String qualifier,
    ...
    @EventListener
    public void handleDataBufferEvent(DataBufferEvent event) {
